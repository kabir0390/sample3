...
<?php 
  foreach ($all_doctor_assign_by_me as  $value) {
    # code...
    ?>
    ...
    <tr>
      ...
      <td class="center">
        <a class="btn btn-primary" href="<?php echo base_url()?>Doctor/view_appointment_information_assign_by_me/<?php echo $value->appointment_id ?>" >
        ...
        <td class="center">
        <a class="btn btn-danger" href="<?php echo base_url()?>Doctor/delete_appointment_information_assign_by_me/<?php echo $value->appointment_id ?>" id="delete">

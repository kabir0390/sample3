...
?>
 <!-- Horizontal Form -->
    ...
    <?php }?>
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>Doctor/save_death_report" method="post">
              <div class="box-body">
 ...
 <div class="form-group">
              ...
              <label><input type="radio" name="death_report_status" value="Inactive">Inactive</label>
                  ...
                  <div class="col-xs-5">
                    <input type="hidden" class="form-control" id="inputEmail3"  required name="death_report_doctor" value="<?php $name=$this->session->userdata('name');
                print_r($name);

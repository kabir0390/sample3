            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li class="active-link">
                        <a href="<?php echo base_url();?>Doctor/dashboard_content" ><i class="fa fa-desktop "></i>Dashboard <span class="badge"></span></a>
                    </li>
                   

                   
                    <li>
                        <a href="<?php echo base_url();?>Doctor/all_doctor"><i class="fa fa-edit "></i>Doctor <span class="badge"></span></a>
                    </li>


                    <li>
                        <a href="<?php echo base_url();?>Doctor/patient"><i class="fa fa-qrcode "></i>Patient</a>
                    </li>
                    <li>
                        <a href="<?php echo base_url();?>Doctor/Schedule"><i class="fa fa-bar-chart-o"></i>Schedule</a>
                    </li>

                    <li>
                        <a href="<?php echo base_url();?>Doctor/appointment"><i class="fa fa-edit "></i>Appointment </a>
                    </li>
                    <li>
                        <a href="<?php echo base_url();?>Doctor/prescription"><i class="fa fa-table "></i>Prescription</a>
                    </li>
                    
                    
                    <li>
                        <a href="<?php echo base_url();?>Doctor/bed_management"><i class="fa fa-edit "></i>Bed Management</a>
                    </li>
                    
                    <li>
                        <a href="<?php echo base_url();?>Doctor/hospital_activities"><i class="fa fa-edit "></i>Hospital Activity</a>
                    </li>

                     <li>
                        <a href="<?php echo base_url();?>Doctor/notice_board"><i class="fa fa-edit "></i>Notice</a>
                    </li>

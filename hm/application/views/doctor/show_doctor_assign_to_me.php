...
<?php 
  foreach ($all_doctor_assign_to_me as  $value) {
    # code...
    ?>
    ...
    <tr>
      ...
      <td class="center"><?php echo $value->status  ?></td>
        ...
        <td class="center">
        <a class="btn btn-primary" href="<?php echo base_url()?>Doctor/view_appointment_information_assign_to_me/<?php echo $value->appointment_id ?>" >
          
          <i class="halflings-icon white trash">View</i>
        </a>
      </td>
        <td class="center">
        <a class="btn btn-danger" href="<?php echo base_url()?>Doctor/delete_appointment_information_assign_to_me/<?php echo $value->appointment_id ?>" id="delete">

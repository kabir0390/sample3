        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="<?php echo base_url();?>Pharmacist/notice_board"><i class="fa fa-edit "></i>Notice Board</a>
                    </li>


                    <li>
                        <a href="<?php echo base_url();?>Pharmacist/hospital_activities"><i class="fa fa-edit "></i>Medicine</a>
                    </li>

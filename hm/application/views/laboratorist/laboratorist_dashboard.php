            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li class="active-link">
                        <a href="<?php echo base_url();?>Laboratorist/dashboard_content" ><i class="fa fa-desktop "></i>Dashboard <span class="badge"></span></a>
                    </li>
                   

                    <li>
                        <a href="<?php echo base_url();?>Laboratorist/laboratory"><i class="fa fa-edit "></i>Laboratory</a>
                    </li>


                    <li>
                        <a href="<?php echo base_url();?>Pharmacist/hospital_activities"><i class="fa fa-edit "></i>Blood Bank</a>
                    </li>


                    <li>
                        <a href="<?php echo base_url();?>Pharmacist/message"><i class="fa fa-edit "></i>Message</a>
                    </li>

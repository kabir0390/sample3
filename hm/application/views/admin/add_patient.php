 <!-- Horizontal Form -->
    ...
    <?php }?>
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>Admin/save_patient" method="post" 
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-xs-5">
                    <input type="text"  class="form-control" id="inputEmail3" placeholder="Enter First Name" required name="patient_new_id" value="<?php 
                        $a=$this->db->select_max('patient_id')->get('db_patient')->result();
                        foreach($a as $row):

...
<?php 
  foreach ($all_death_report as  $value) {
    # code...
    ?>
    ...
    <tr>
      ...
      <td class="center"><a class="btn btn-primary" href="<?php echo base_url();?>Admin/view_death_report/<?php echo $value->death_report_id; ?>" ><i class="halflings-icon white edit">View</i></a></td>
     
      <td class="center">
        <a class="btn btn-danger" href="<?php echo base_url()?>Admin/delete_birth_report/<?php echo $value->death_report_id ;?>" id="delete">

...
<?php 
  foreach ($all_employee_accountant as  $value) {
    # code...
    ?>
...
<td class="center"><a class="btn btn-info" href="<?php echo base_url();?>Admin/update_employee_accountant/<?php echo $value->employee_id ;?>" ><i class="halflings-icon white edit">Update</i></a></td>
     
      <td class="center">
        <a class="btn btn-danger" href="<?php echo base_url()?>Admin/delete_employee_accountant/<?php echo $value->employee_id ;?>" id="delete">

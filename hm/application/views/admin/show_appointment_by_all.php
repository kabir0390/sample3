...
<?php 
  foreach ($appoinment_by_all as  $value) {
    # code...
    ?>
    ...
    <tr>
      ...
      <td class="center"><?php echo $value->appointment_date ?></td>
       <td class="center"><?php echo $value->appointment_time ?></td>
        ...
        <td class="center"><a class="btn btn-primary" href="<?php echo base_url();?>Admin/view_appointment_information/<?php echo $value->appointment_id; ?>" ><i class="halflings-icon white edit">View</i></a></td>
     
     
     
      <td class="center">
        <a class="btn btn-danger" href="<?php echo base_url()?>Admin/delete_appointment/<?php echo $value->appointment_id; ?>" id="delete">

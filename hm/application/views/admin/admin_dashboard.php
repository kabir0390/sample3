...
<head>
 ...
 <link rel="stylesheet" href="<?php echo base_url();?>assets/prescription/boot.css" />  
           <script src="<?php echo base_url();?>assets/prescription/boot1.js"></script>  
           <script src="<?php echo base_url();?>assets/prescription/boot2.js"></script>  
...
<body>
    ...
    <div id="wrapper">
         <div class="navbar navbar-inverse navbar-fixed-top" style="background-color: #681515">
    ...
    <li><a href="#"><i class="fa fa-unlock"></i> Make admin</a></li>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="<?php echo base_url();?>Admin/department"><i class="fa fa-table "></i>Department<span class="badge"></span></a>
                    </li>
                    <li>
                        <a href="<?php echo base_url();?>Admin/doctor"><i class="fa fa-edit "></i>Doctor <span class="badge"></span></a>
                    </li>


                    <li>
                        <a href="<?php echo base_url();?>Admin/patient"><i class="fa fa-qrcode "></i>Patient</a>
                    </li>
                    <li>
                        <a href="<?php echo base_url();?>Admin/Schedule"><i class="fa fa-bar-chart-o"></i>Schedule</a>
                    </li>

                    <li>
                        <a href="<?php echo base_url();?>Admin/appointment"><i class="fa fa-edit "></i>Appointment </a>
                    </li>
                    <li>
                        <a href="<?php echo base_url();?>Admin/prescription"><i class="fa fa-table "></i>Prescription</a>
                    </li>
                     <li>
                        <a href="<?php echo base_url();?>Admin/account_manager"><i class="fa fa-edit "></i>Account Manager</a>
                    </li>

                    <li>
                        <a href="<?php echo base_url();?>Admin/human_resource"><i class="fa fa-edit "></i>Human Resourcce</a>
                    </li>
                    
                    <li>
                        <a href="<?php echo base_url();?>Admin/bed_management"><i class="fa fa-edit "></i>Bed Management</a>
                    </li>
                    
                    <li>
                        <a href="<?php echo base_url();?>Admin/hospital_activities"><i class="fa fa-edit "></i>Hospital Activity</a>
                    </li>

                    <li>
                        <a href="<?php echo base_url();?>Admin/bloodbank"><i class="fa fa-edit "></i>Blood Bank</a>
                    </li>


                    <li>
                        <a href="<?php echo base_url();?>Admin/notice_board"><i class="fa fa-edit "></i>Notice Board</a>
                    </li>


                     <li>
                        <a href="<?php echo base_url();?>Admin/message"><i class="fa fa-edit "></i>Message</a>
                    </li>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-lg-12">
                     <h3 style="text-align: right;">Admin:

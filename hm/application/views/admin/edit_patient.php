 <!-- Horizontal Form -->
    ...
    <?php }?>
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>Admin/update_patient_data" method="post" 
              ...
              <div class="box-body">
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-xs-5">
                    <input type="hidden" class="form-control" id="inputEmail3"  required name="patient_id" value="<?php echo $update_patient->patient_id ;?>">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-xs-5">
                    <input type="text" class="form-control" id="inputEmail3"  required name="patient_first_name" value="<?php echo $update_patient->patient_first_name ;?>">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-xs-5">
                    <input type="text" class="form-control" id="inputEmail3" required name="patient_last_name" value="<?php echo $update_patient->patient_last_name ;?>">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-xs-5">
                    <input type="email" class="form-control" id="inputEmail3"  required name="patient_email" value="<?php echo $update_patient->patient_email ;?>">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-xs-5">
                    <input type="password" class="form-control" id="inputEmail3"  required name="patient_password" value="<?php echo $update_patient->patient_password ;?>">
                  </div>
                </div>
               ...
               <div class="form-group">
                  ...
                  <div class="col-xs-5">
                    <textarea class="form-control" rows="3" placeholder="Enter ..." name="patient_address"><?php echo $update_patient->patient_address ;?></textarea>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-xs-5">
                    <input type="text" class="form-control" id="inputEmail3"  required name="patient_phone" value="<?php echo $update_patient->patient_phone ;?>">
                  </div>
                </div>
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-xs-5">
                    ...
                    name="patient_mobile" value="<?php echo $update_patient->patient_mobile ;?>">
                  </div>
                </div>
<!----------
                <div class="form-group">
...
-------------------->
               <div class="form-group">
                  ...
                  <div class="col-xs-5">
                     <input type="date"   min="2000-01-02" class="signup_input"  name="patient_birth_date" value="<?php echo $update_patient->patient_birth_date ;?>">
                  </div>
                </div>

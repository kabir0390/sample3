        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="<?php echo base_url();?>Receptionist/doctor_list"><i class="fa fa-edit "></i>Doctor</a>
                    </li>


                    <li>
                        <a href="<?php echo base_url();?>Receptionist/patient"><i class="fa fa-edit "></i>Patient</a>
                    </li>


                    <li>
                        <a href="<?php echo base_url();?>Receptionist/schedule"><i class="fa fa-edit "></i>Schedule</a>
                    </li>

                    <li>
                        <a href="<?php echo base_url();?>Receptionist/appointment"><i class="fa fa-edit "></i>Appointment</a>
                    </li>
                     <li>
                        <a href="<?php echo base_url();?>Receptionist/notice"><i class="fa fa-edit "></i>Notice</a>
                    </li>
                    ...
                    <li>
                        <a href="<?php echo base_url();?>Receptionist/message"><i class="fa fa-edit "></i>Message</a>
                    </li>
